...
var SfdtExport = /** @class */ (function () {
        ...
        for (var i = 0; i < lineWidget.children.length; i++) {
            ...
            if (this.startContent && ((this.contentType !== 'Row') && (this.contentType !== 'Block') && (this.contentType !== 'Cell'))) {
                if (this.multipleLineContent) {
                    ...
                    var contentinline = this.inlineContentControl(contentInline, element, lineWidget.children[i + 1]);
    ...
    SfdtExport.prototype.inlineContentControl = function (contentInline, element, nextElement, inlines) {
        var inline = {};
